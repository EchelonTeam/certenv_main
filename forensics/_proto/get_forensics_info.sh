...
cat /proc/partitions > $O_DIR/drive-img/info_proc_partitions.txt
sudo fdisk -l > $O_DIR/drive-img/info_fdisk_l.txt
...
echo Verifying produced images...
affverify $O_DIR/drive-img/aimage-${DR_IMG[@]}.aff >> $O_DIR/drive-img/aimage-verification.log
